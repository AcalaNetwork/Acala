...
fn testnet_genesis(
	...
	use mandala_runtime::{
		get_all_module_accounts, AcalaOracleConfig, AirDropConfig, BalancesConfig, BandOracleConfig, CdpEngineConfig,
		CdpTreasuryConfig, CurrencyId, DexConfig, EVMConfig, EnabledTradingPairs, GeneralCouncilMembershipConfig,

...
use acala_primitives::{AccountId, Balance, Block, CurrencyId, DataProviderId, Nonce};
...
pub trait RuntimeApiCollection<UncheckedExtrinsic>:
	...
	+ orml_oracle_rpc::OracleRuntimeApi<Block, DataProviderId, CurrencyId, dev_runtime::TimeStampedPrice>

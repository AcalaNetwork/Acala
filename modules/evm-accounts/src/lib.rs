...
pub use module::*;
pub use module_weights::ModuleWeights;
...
impl<T: Config> Pallet<T> {
	...
	// would sign.
	#[orml_weight_meter::weight(ModuleWeights::<T>::ethereum_signable_message())]
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::eth_recover())]
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::eth_public())]
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::eth_address())]
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::eth_sign())]
	...
	T::AccountId: IsType<AccountId32>,
{
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::get_account_id())]
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::get_evm_address())]
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::get_or_create_evm_address())]
	...
	#[orml_weight_meter::weight(ModuleWeights::<T>::get_default_evm_address())]
	...
	// and false if is not.
	#[orml_weight_meter::weight(ModuleWeights::<T>::is_linked())]

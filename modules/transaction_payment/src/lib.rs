...
pub mod module {
		...
		PalletBalanceOf<T>: FixedPointOperand,
	{
		...
		///     transaction. It is declared as a base _weight_ in the runtime
		///     and converted to a fee using `WeightToFee`.
		///   - `len_fee`: The length fee, the amount paid for the encoded
		...
		///     transaction.
		///   - `targeted_fee_adjustment`: This is a multiplier that can tune
		///     the final fee based on the congestion of the network.
		///   - (Optional) `tip`: If included in the transaction, the tip will
		///     be added on top. Only signed transactions can have a tip.
		///

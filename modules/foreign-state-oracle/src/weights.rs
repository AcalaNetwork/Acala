...
// --steps=50
// --repeat=20
// --pallet=module_foreign_state_oracle
// --extrinsic=*
// --execution=wasm
// --wasm-execution=compiled
// --heap-pages=4096
// --output=./modules/foreign-state-oracle/src/weights.rs
...
/// Weight functions needed for module_foreign_state_oracle.
pub trait WeightInfo {
	fn purge_expired_query() -> Weight;
	fn respond_query_request() -> Weight;
}

/// Weights for module_foreign_state_oracle using the Acala node and recommended hardware.

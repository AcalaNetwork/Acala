...
impl<T: frame_system::Config> WeightInfo for AcalaWeight<T> {
	...
	fn unauthorize_all(c: u32, ) -> Weight {
		(61_985_000 as Weight)
			// Standard Error: 817_000
			.saturating_add((8_601_000 as Weight).saturating_mul(c as Weight))

...
impl<T: frame_system::Config> module_collator_selection::WeightInfo for WeightInfo<T> {
	...
	fn start_session(_r: u32, c: u32, ) -> Weight {
		(8_678_000 as Weight)
			...
			.saturating_add((988_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	...
	fn end_session(_r: u32, c: u32, ) -> Weight {
		(411_963_000 as Weight)
			// Standard Error: 20_000
			.saturating_add((6_584_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))

...
impl<T: frame_system::Config> module_collator_selection::WeightInfo for WeightInfo<T> {
	...
	fn start_session(r: u32, c: u32, ) -> Weight {
		(7_440_000 as Weight)
			...
			// Standard Error: 9_000
			.saturating_add((1_095_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	...
	fn end_session(_r: u32, c: u32, ) -> Weight {
		(500_006_000 as Weight)
			// Standard Error: 33_000
			.saturating_add((5_978_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))

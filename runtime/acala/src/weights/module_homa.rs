...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(53_278_000 as Weight)
			// Standard Error: 148_000
			.saturating_add((52_440_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(6_025_000 as Weight)
			...
			.saturating_add((7_813_000 as Weight).saturating_mul(n as Weight))

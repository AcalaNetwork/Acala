...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(4_217_000 as Weight)
			...
			.saturating_add((51_864_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(7_725_000 as Weight)
			...
			.saturating_add((8_807_000 as Weight).saturating_mul(n as Weight))

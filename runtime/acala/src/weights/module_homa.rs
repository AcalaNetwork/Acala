...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize() -> Weight {
		...
		Weight::from_ref_time(5_888_000)
	...
	fn on_initialize_with_bump_era() -> Weight {
		// Minimum execution time: 249_189 nanoseconds.
		Weight::from_ref_time(255_741_000)
	...
	// Storage: Homa EstimatedRewardRatePerEra (r:1 w:0)
	fn mint() -> Weight {
		// Minimum execution time: 74_289 nanoseconds.
		Weight::from_ref_time(76_056_000)
	...
	fn request_redeem() -> Weight {
		// Minimum execution time: 48_219 nanoseconds.
		Weight::from_ref_time(50_045_000)
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		// Minimum execution time: 84_759 nanoseconds.
		Weight::from_ref_time(24_832_917)
			// Standard Error: 33_827
			.saturating_add(Weight::from_ref_time(51_030_790).saturating_mul(n.into()))
	...
	fn claim_redemption() -> Weight {
		// Minimum execution time: 70_319 nanoseconds.
		Weight::from_ref_time(72_159_000)
	...
	fn update_homa_params() -> Weight {
		// Minimum execution time: 29_653 nanoseconds.
		Weight::from_ref_time(30_630_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	// Storage: ParachainSystem ValidationData (r:1 w:0)
	...
	fn update_bump_era_params() -> Weight {
		...
		Weight::from_ref_time(22_694_000)
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		...
		Weight::from_ref_time(11_544_822)
			// Standard Error: 39_678
			.saturating_add(Weight::from_ref_time(8_561_671).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))

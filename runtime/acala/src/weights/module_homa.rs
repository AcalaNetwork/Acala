...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(11_593_000 as Weight)
			...
			.saturating_add((52_412_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(9_996_000 as Weight)
			...
			.saturating_add((8_769_000 as Weight).saturating_mul(n as Weight))

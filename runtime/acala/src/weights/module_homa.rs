...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_bump_era() -> Weight {
		Weight::from_ref_time(249_862_000)
			.saturating_add(T::DbWeight::get().reads(34 as u64))
	...
	// Storage: Homa EstimatedRewardRatePerEra (r:1 w:0)
	fn mint() -> Weight {
		Weight::from_ref_time(75_747_000)
	...
	fn request_redeem() -> Weight {
		Weight::from_ref_time(46_042_000)
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		Weight::from_ref_time(11_593_000)
			...
			.saturating_add(Weight::from_ref_time(52_412_000).saturating_mul(n as u64))
	...
	fn claim_redemption() -> Weight {
		Weight::from_ref_time(93_419_000)
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		Weight::from_ref_time(9_996_000)
			...
			.saturating_add(Weight::from_ref_time(8_769_000).saturating_mul(n as u64))

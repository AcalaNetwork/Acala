...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(28_549_000 as Weight)
			// Standard Error: 68_000
			.saturating_add((88_692_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((20_407_000 as Weight).saturating_mul(n as Weight))

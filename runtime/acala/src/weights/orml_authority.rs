...
impl<T: frame_system::Config> orml_authority::WeightInfo for WeightInfo<T> {
	...
	fn schedule_dispatch_without_delay() -> Weight {
		...
		Weight::from_parts(25_941_000, 11318)
	...
	fn schedule_dispatch_with_delay() -> Weight {
		...
		Weight::from_parts(26_587_000, 11318)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn fast_track_scheduled_dispatch() -> Weight {
		...
		//  Measured:  `1220`
		//  Estimated: `21646`
		// Minimum execution time: 34_209 nanoseconds.
		Weight::from_parts(35_004_000, 21646)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn delay_scheduled_dispatch() -> Weight {
		...
		//  Measured:  `1220`
		//  Estimated: `21646`
		// Minimum execution time: 34_547 nanoseconds.
		Weight::from_parts(34_917_000, 21646)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn cancel_scheduled_dispatch() -> Weight {
		...
		//  Measured:  `1220`
		//  Estimated: `11318`
		// Minimum execution time: 27_313 nanoseconds.
		Weight::from_parts(27_809_000, 11318)
	...
	fn authorize_call() -> Weight {
		...
		Weight::from_parts(13_875_000, 997)
	...
	fn remove_authorized_call() -> Weight {
		...
		Weight::from_parts(19_134_000, 4803)
	...
	fn trigger_call() -> Weight {
		...
		//  Measured:  `1338`
		//  Estimated: `4803`
		// Minimum execution time: 22_505 nanoseconds.
		Weight::from_parts(23_074_000, 4803)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

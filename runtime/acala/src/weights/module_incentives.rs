...
impl<T: frame_system::Config> module_incentives::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(10_638_652)
			// Standard Error: 59_076
			.saturating_add(Weight::from_ref_time(14_840_439).saturating_mul(c.into()))
	...
	fn deposit_dex_share() -> Weight {
		// Minimum execution time: 59_729 nanoseconds.
		Weight::from_ref_time(61_115_000)
	...
	fn withdraw_dex_share() -> Weight {
		// Minimum execution time: 58_241 nanoseconds.
		Weight::from_ref_time(60_098_000)
	...
	fn claim_rewards() -> Weight {
		...
		Weight::from_ref_time(66_080_000)
			.saturating_add(T::DbWeight::get().reads(6))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn update_incentive_rewards(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(7_396_437)
			// Standard Error: 84_772
			.saturating_add(Weight::from_ref_time(7_322_631).saturating_mul(c.into()))
	...
	fn update_claim_reward_deduction_rates(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(5_320_326)
			// Standard Error: 15_926
			.saturating_add(Weight::from_ref_time(1_833_369).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(c.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(c.into())))
	}
}

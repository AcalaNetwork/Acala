...
impl<T: frame_system::Config> module_incentives::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(c: u32, ) -> Weight {
		Weight::from_ref_time(7_124_000)
			...
			.saturating_add(Weight::from_ref_time(14_301_000).saturating_mul(c as u64))
	...
	fn deposit_dex_share() -> Weight {
		Weight::from_ref_time(56_513_000)
	...
	fn withdraw_dex_share() -> Weight {
		Weight::from_ref_time(56_033_000)
	...
	fn claim_rewards() -> Weight {
		Weight::from_ref_time(59_643_000)
			.saturating_add(T::DbWeight::get().reads(7 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	// Storage: unknown [0x3a7472616e73616374696f6e5f6c6576656c3a] (r:1 w:1)
	...
	fn update_incentive_rewards(c: u32, ) -> Weight {
		Weight::from_ref_time(6_490_000)
			...
			.saturating_add(Weight::from_ref_time(6_785_000).saturating_mul(c as u64))
	...
	fn update_claim_reward_deduction_rates(c: u32, ) -> Weight {
		Weight::from_ref_time(4_071_000)
			// Standard Error: 16_000
			.saturating_add(Weight::from_ref_time(2_036_000).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(c as u64)))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(c as u64)))

...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		...
		//  Measured:  `2433`
		//  Estimated: `23113`
		// Minimum execution time: 109_418 nanoseconds.
		Weight::from_parts(112_138_000, 23113)
	...
	fn on_finalize(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2565 + c * (979 ±0)`
		//  Estimated: `49037 + c * (9624 ±0)`
		// Minimum execution time: 109_986 nanoseconds.
		Weight::from_parts(63_558_340, 49037)
			// Standard Error: 19_816
			.saturating_add(Weight::from_parts(48_805_316, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(14))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(c.into())))
			.saturating_add(T::DbWeight::get().writes(7))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(c.into())))
			.saturating_add(Weight::from_parts(0, 9624).saturating_mul(c.into()))
	}
}

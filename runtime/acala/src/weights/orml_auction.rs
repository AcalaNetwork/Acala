...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		...
		//  Measured:  `2500`
		//  Estimated: `8856`
		// Minimum execution time: 85_873 nanoseconds.
		Weight::from_parts(89_006_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		...
		// Minimum execution time: 93_141 nanoseconds.
		Weight::from_parts(36_954_597, 9000)
			// Standard Error: 32_541
			.saturating_add(Weight::from_parts(42_236_707, 0).saturating_mul(c.into()))

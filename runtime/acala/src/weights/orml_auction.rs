...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		...
		Weight::from_parts(103_403_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		...
		// Minimum execution time: 104_282 nanoseconds.
		Weight::from_parts(59_081_808, 9000)
			// Standard Error: 18_711
			.saturating_add(Weight::from_parts(46_196_581, 0).saturating_mul(c.into()))

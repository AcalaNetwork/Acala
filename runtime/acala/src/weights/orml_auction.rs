...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid() -> Weight {
		...
		Weight::from_parts(123_462_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		...
		// Minimum execution time: 129_985 nanoseconds.
		Weight::from_parts(56_520_260, 9000)
			// Standard Error: 24_525
			.saturating_add(Weight::from_parts(70_537_558, 0).saturating_mul(c.into()))

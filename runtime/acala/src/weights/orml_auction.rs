...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		// Minimum execution time: 90_244 nanoseconds.
		Weight::from_ref_time(93_167_000)
	...
	fn on_finalize(c: u32, ) -> Weight {
		// Minimum execution time: 93_447 nanoseconds.
		Weight::from_ref_time(40_781_824)
			// Standard Error: 21_737
			.saturating_add(Weight::from_ref_time(44_259_516).saturating_mul(c.into()))

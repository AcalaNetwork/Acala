...
impl<T: frame_system::Config> module_evm::WeightInfo for WeightInfo<T> {
	...
	fn set_code(c: u32, ) -> Weight {
		(137_686_000 as Weight)
			// Standard Error: 0
			.saturating_add((12_000 as Weight).saturating_mul(c as Weight))

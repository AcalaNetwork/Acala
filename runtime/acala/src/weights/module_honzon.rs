...
impl<T: frame_system::Config> module_honzon::WeightInfo for WeightInfo<T> {
	...
	fn unauthorize_all(c: u32, ) -> Weight {
		(26_991_000 as Weight)
			// Standard Error: 182_000
			.saturating_add((8_043_000 as Weight).saturating_mul(c as Weight))

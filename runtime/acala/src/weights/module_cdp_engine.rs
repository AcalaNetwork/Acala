...
impl<T: frame_system::Config> module_cdp_engine::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(22_485_461)
			// Standard Error: 26_869
			.saturating_add(Weight::from_ref_time(7_190_892).saturating_mul(c.into()))
	...
	fn liquidate_by_auction(b: u32, ) -> Weight {
		// Minimum execution time: 182_284 nanoseconds.
		Weight::from_ref_time(188_206_153)
			// Standard Error: 21_554
			.saturating_add(Weight::from_ref_time(11_489_833).saturating_mul(b.into()))
	...
	fn liquidate_by_dex() -> Weight {
		// Minimum execution time: 284_235 nanoseconds.
		Weight::from_ref_time(291_089_000)
	...
	// Storage: Loans TotalPositions (r:1 w:1)
	fn settle() -> Weight {
		// Minimum execution time: 104_203 nanoseconds.
		Weight::from_ref_time(107_106_000)

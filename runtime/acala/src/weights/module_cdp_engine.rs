...
impl<T: frame_system::Config> module_cdp_engine::WeightInfo for WeightInfo<T> {
	...
	// Storage: `CdpEngine::CollateralParams` (r:6 w:0)
	...
	fn on_initialize(c: u32, ) -> Weight {
		...
		Weight::from_parts(20_365_969, 3600)
			// Standard Error: 34_196
			.saturating_add(Weight::from_parts(6_939_753, 0).saturating_mul(c.into()))
	...
	fn set_collateral_params() -> Weight {
		...
		Weight::from_parts(26_973_000, 3600)
	...
	fn liquidate_by_auction(b: u32, ) -> Weight {
		...
		//  Measured:  `2033`
		//  Estimated: `9000`
		// Minimum execution time: 266_567 nanoseconds.
		Weight::from_parts(271_671_565, 9000)
			// Standard Error: 29_490
			.saturating_add(Weight::from_parts(15_673_874, 0).saturating_mul(b.into()))
	...
	fn liquidate_by_dex() -> Weight {
		...
		//  Measured:  `2836`
		//  Estimated: `16722`
		// Minimum execution time: 399_836 nanoseconds.
		Weight::from_parts(409_640_000, 16722)
	...
	fn settle() -> Weight {
		...
		Weight::from_parts(141_291_000, 6234)
	...
	fn register_liquidation_contract() -> Weight {
		...
		Weight::from_parts(13_247_000, 1686)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `CdpEngine::LiquidationContracts` (r:1 w:1)
	...
	fn deregister_liquidation_contract() -> Weight {
		...
		Weight::from_parts(14_201_000, 1686)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

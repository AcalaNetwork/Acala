...
impl<T: frame_system::Config> module_asset_registry::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset() -> Weight {
		...
		Weight::from_parts(26_140_000, 3607)
	...
	fn update_foreign_asset() -> Weight {
		...
		//  Measured:  `298`
		//  Estimated: `3763`
		// Minimum execution time: 25_212 nanoseconds.
		Weight::from_parts(25_691_000, 3763)
	...
	fn register_stable_asset() -> Weight {
		...
		Weight::from_parts(16_833_000, 3607)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn update_stable_asset() -> Weight {
		...
		Weight::from_parts(18_817_000, 3701)
	...
	fn register_erc20_asset() -> Weight {
		...
		//  Measured:  `4745`
		//  Estimated: `18110`
		// Minimum execution time: 250_237 nanoseconds.
		Weight::from_parts(256_987_000, 18110)
	...
	fn update_erc20_asset() -> Weight {
		...
		Weight::from_parts(30_904_000, 3852)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn register_native_asset() -> Weight {
		...
		//  Measured:  `142`
		//  Estimated: `3607`
		// Minimum execution time: 15_094 nanoseconds.
		Weight::from_parts(15_682_000, 3607)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn update_native_asset() -> Weight {
		...
		Weight::from_parts(17_465_000, 3676)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

...
impl<T: frame_system::Config> module_asset_registry::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset() -> Weight {
		...
		Weight::from_parts(21_870_000, 4604)
	...
	fn update_foreign_asset() -> Weight {
		...
		//  Measured:  `1295`
		//  Estimated: `4760`
		// Minimum execution time: 21_385 nanoseconds.
		Weight::from_parts(21_823_000, 4760)
	...
	fn register_stable_asset() -> Weight {
		...
		Weight::from_parts(16_569_000, 4604)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn update_stable_asset() -> Weight {
		...
		Weight::from_parts(18_044_000, 4698)
	...
	fn register_erc20_asset() -> Weight {
		...
		//  Measured:  `6845`
		//  Estimated: `20210`
		// Minimum execution time: 196_952 nanoseconds.
		Weight::from_parts(200_056_000, 20210)
	...
	fn update_erc20_asset() -> Weight {
		...
		Weight::from_parts(26_552_000, 4849)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn register_native_asset() -> Weight {
		...
		Weight::from_parts(15_934_000, 4604)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn update_native_asset() -> Weight {
		...
		Weight::from_parts(16_854_000, 4673)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

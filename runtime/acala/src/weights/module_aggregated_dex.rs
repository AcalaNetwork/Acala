...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		...
		// Minimum execution time: 101_926 nanoseconds.
		Weight::from_parts(81_165_018, 6234)
			// Standard Error: 64_206
			.saturating_add(Weight::from_parts(11_830_707, 0).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		//  Measured:  `1809 + u * (112 ±0)`
		//  Estimated: `6234 + u * (643 ±19)`
		// Minimum execution time: 110_082 nanoseconds.
		Weight::from_parts(78_416_425, 6234)
			// Standard Error: 80_433
			.saturating_add(Weight::from_parts(17_514_695, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_182_130, 666)
			// Standard Error: 11_575
			.saturating_add(Weight::from_parts(1_474_268, 0).saturating_mul(n.into()))

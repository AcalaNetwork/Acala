...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		(60_296_000 as Weight)
			// Standard Error: 409_000
			.saturating_add((17_258_000 as Weight).saturating_mul(u as Weight))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		(49_177_000 as Weight)
			// Standard Error: 1_730_000
			.saturating_add((27_045_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(u as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(u as Weight)))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		(3_771_000 as Weight)
			...
			.saturating_add((2_008_000 as Weight).saturating_mul(n as Weight))

...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		// Minimum execution time: 74_286 nanoseconds.
		Weight::from_ref_time(54_557_977)
			// Standard Error: 69_330
			.saturating_add(Weight::from_ref_time(11_146_957).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		// Minimum execution time: 82_453 nanoseconds.
		Weight::from_ref_time(51_862_469)
			// Standard Error: 73_236
			.saturating_add(Weight::from_ref_time(16_738_113).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		// Minimum execution time: 4_796 nanoseconds.
		Weight::from_ref_time(4_468_567)
			// Standard Error: 10_766
			.saturating_add(Weight::from_ref_time(1_512_519).saturating_mul(n.into()))

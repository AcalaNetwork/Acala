...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		...
		// Minimum execution time: 87_750 nanoseconds.
		Weight::from_parts(69_674_328, 6234)
			// Standard Error: 60_494
			.saturating_add(Weight::from_parts(10_698_189, 0).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		Weight::from_parts(66_734_925, 6234)
			// Standard Error: 69_833
			.saturating_add(Weight::from_parts(16_142_227, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_567_886, 666)
			// Standard Error: 10_823
			.saturating_add(Weight::from_parts(1_387_264, 0).saturating_mul(n.into()))

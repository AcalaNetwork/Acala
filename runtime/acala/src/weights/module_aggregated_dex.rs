...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		...
		// Minimum execution time: 100_348 nanoseconds.
		Weight::from_parts(81_415_624, 6234)
			// Standard Error: 70_090
			.saturating_add(Weight::from_parts(11_003_080, 0).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		// Minimum execution time: 108_411 nanoseconds.
		Weight::from_parts(76_876_967, 6234)
			// Standard Error: 72_181
			.saturating_add(Weight::from_parts(17_163_434, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_330_195, 666)
			// Standard Error: 10_736
			.saturating_add(Weight::from_parts(1_422_758, 0).saturating_mul(n.into()))

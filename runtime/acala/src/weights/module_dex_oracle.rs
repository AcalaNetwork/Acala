...
impl<T: frame_system::Config> module_dex_oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_update_average_prices(n: u32, u: u32, ) -> Weight {
		// Minimum execution time: 15_386 nanoseconds.
		Weight::from_ref_time(15_967_000)
			// Standard Error: 133_743
			.saturating_add(Weight::from_ref_time(11_066_812).saturating_mul(n.into()))
			// Standard Error: 133_743
			.saturating_add(Weight::from_ref_time(4_225_918).saturating_mul(u.into()))
	...
	fn enable_average_price() -> Weight {
		// Minimum execution time: 18_390 nanoseconds.
		Weight::from_ref_time(18_981_000)
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn disable_average_price() -> Weight {
		...
		Weight::from_ref_time(11_553_000)
	...
	fn update_average_price_interval() -> Weight {
		...
		Weight::from_ref_time(11_296_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

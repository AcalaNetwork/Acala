...
impl<T: frame_system::Config> module_dex_oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_update_average_prices(n: u32, u: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 654_000
			.saturating_add((20_606_000 as Weight).saturating_mul(n as Weight))
			// Standard Error: 654_000
			.saturating_add((11_983_000 as Weight).saturating_mul(u as Weight))

...
impl<T: frame_system::Config> module_dex_oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_update_average_prices(n: u32, u: u32, ) -> Weight {
		...
		Weight::from_ref_time(16_075_000)
			// Standard Error: 133_609
			.saturating_add(Weight::from_ref_time(11_005_173).saturating_mul(n.into()))
			// Standard Error: 133_609
			.saturating_add(Weight::from_ref_time(4_198_437).saturating_mul(u.into()))
	...
	fn enable_average_price() -> Weight {
		...
		Weight::from_ref_time(18_742_000)
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn disable_average_price() -> Weight {
		...
		Weight::from_ref_time(11_513_000)
	...
	fn update_average_price_interval() -> Weight {
		...
		Weight::from_ref_time(11_096_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

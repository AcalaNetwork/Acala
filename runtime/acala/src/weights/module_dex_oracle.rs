...
impl<T: frame_system::Config> module_dex_oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_update_average_prices(n: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(16_075_000, 0)
			...
			.saturating_add(Weight::from_parts(11_005_173, 0).saturating_mul(n.into()))
			// Standard Error: 133_609
			.saturating_add(Weight::from_parts(4_198_437, 0).saturating_mul(u.into()))
	...
	fn update_average_price_interval() -> Weight {
		...
		Weight::from_parts(11_096_000, 0)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

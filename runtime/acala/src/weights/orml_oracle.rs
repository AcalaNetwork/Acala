...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(c: u32, ) -> Weight {
		...
		Weight::from_parts(22_031_444, 3086)
			// Standard Error: 46_977
			.saturating_add(Weight::from_parts(6_477_999, 0).saturating_mul(c.into()))
	...
	fn on_finalize() -> Weight {
		...
		//  Measured:  `872`
		//  Estimated: `0`
		// Minimum execution time: 6_908 nanoseconds.
		Weight::from_parts(7_069_000, 0)
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(c: u32, ) -> Weight {
		...
		// Minimum execution time: 20_578 nanoseconds.
		Weight::from_parts(22_727_264, 3086)
			// Standard Error: 46_902
			.saturating_add(Weight::from_parts(6_393_985, 0).saturating_mul(c.into()))

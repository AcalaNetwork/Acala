...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(18_783_134)
			// Standard Error: 41_690
			.saturating_add(Weight::from_ref_time(5_760_491).saturating_mul(c.into()))
	...
	fn on_finalize() -> Weight {
		// Minimum execution time: 5_865 nanoseconds.
		Weight::from_ref_time(6_144_000)
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

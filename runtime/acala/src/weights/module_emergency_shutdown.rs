...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		//  Measured:  `1284`
		//  Estimated: `5086`
		// Minimum execution time: 24_808 nanoseconds.
		Weight::from_parts(25_820_697, 5086)
			// Standard Error: 14_248
			.saturating_add(Weight::from_parts(613_576, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		//  Measured:  `1308`
		//  Estimated: `5086`
		// Minimum execution time: 24_565 nanoseconds.
		Weight::from_parts(25_083_000, 5086)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1991 + c * (45 ±0)`
		//  Estimated: `15755`
		// Minimum execution time: 59_999 nanoseconds.
		Weight::from_parts(62_534_150, 15755)
			// Standard Error: 27_516
			.saturating_add(Weight::from_parts(2_044_175, 0).saturating_mul(c.into()))

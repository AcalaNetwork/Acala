...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	// Storage: Prices LockedPrice (r:0 w:3)
	fn emergency_shutdown(c: u32, ) -> Weight {
		(104_560_000 as Weight)
			// Standard Error: 1_512_000
			.saturating_add((14_812_000 as Weight).saturating_mul(c as Weight))
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		(95_132_000 as Weight)
			// Standard Error: 1_021_000
			.saturating_add((38_233_000 as Weight).saturating_mul(c as Weight))

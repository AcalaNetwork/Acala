...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		Weight::from_parts(22_826_530, 3600)
			// Standard Error: 8_693
			.saturating_add(Weight::from_parts(332_269, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		//  Measured:  `1342`
		//  Estimated: `3600`
		// Minimum execution time: 21_752 nanoseconds.
		Weight::from_parts(22_223_000, 3600)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		...
		//  Estimated: `3612`
		// Minimum execution time: 55_131 nanoseconds.
		Weight::from_parts(56_761_378, 3612)
			// Standard Error: 19_905
			.saturating_add(Weight::from_parts(1_913_471, 0).saturating_mul(c.into()))

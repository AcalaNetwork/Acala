...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		Weight::from_parts(18_220_029, 3600)
			// Standard Error: 10_241
			.saturating_add(Weight::from_parts(424_797, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		Weight::from_parts(17_580_000, 3600)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		...
		//  Estimated: `3612`
		// Minimum execution time: 47_090 nanoseconds.
		Weight::from_parts(48_803_280, 3612)
			// Standard Error: 22_173
			.saturating_add(Weight::from_parts(1_765_463, 0).saturating_mul(c.into()))

...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		Weight::from_parts(23_961_033, 3600)
			// Standard Error: 12_418
			.saturating_add(Weight::from_parts(499_756, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		//  Measured:  `1342`
		//  Estimated: `3600`
		// Minimum execution time: 22_647 nanoseconds.
		Weight::from_parts(23_112_000, 3600)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2025 + c * (45 ±0)`
		//  Estimated: `3612`
		// Minimum execution time: 55_893 nanoseconds.
		Weight::from_parts(58_323_946, 3612)
			// Standard Error: 26_362
			.saturating_add(Weight::from_parts(2_081_803, 0).saturating_mul(c.into()))

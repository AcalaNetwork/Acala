...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		//  Measured:  `2043`
		//  Estimated: `3612`
		// Minimum execution time: 45_378 nanoseconds.
		Weight::from_parts(41_737_451, 3612)
			// Standard Error: 18_050
			.saturating_add(Weight::from_parts(12_589_626, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `4648`
		//  Estimated: `21966`
		// Minimum execution time: 379_651 nanoseconds.
		Weight::from_parts(388_487_000, 21966)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		//  Measured:  `1468`
		//  Estimated: `6234`
		// Minimum execution time: 45_160 nanoseconds.
		Weight::from_parts(46_433_000, 6234)

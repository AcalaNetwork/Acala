...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		Weight::from_parts(45_583_861, 3612)
			// Standard Error: 19_334
			.saturating_add(Weight::from_parts(12_894_879, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `4615`
		//  Estimated: `21966`
		// Minimum execution time: 384_023 nanoseconds.
		Weight::from_parts(394_898_000, 21966)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		//  Measured:  `1468`
		//  Estimated: `6234`
		// Minimum execution time: 46_124 nanoseconds.
		Weight::from_parts(46_833_000, 6234)

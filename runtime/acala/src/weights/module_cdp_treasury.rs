...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		Weight::from_parts(38_579_025, 3612)
			// Standard Error: 17_264
			.saturating_add(Weight::from_parts(9_288_337, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `4648`
		//  Estimated: `21966`
		// Minimum execution time: 326_455 nanoseconds.
		Weight::from_parts(333_366_000, 21966)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		//  Measured:  `1468`
		//  Estimated: `6234`
		// Minimum execution time: 36_714 nanoseconds.
		Weight::from_parts(37_322_000, 6234)

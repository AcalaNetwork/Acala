...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		Weight::from_parts(45_235_403, 3612)
			// Standard Error: 25_771
			.saturating_add(Weight::from_parts(15_206_600, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `2469`
		//  Estimated: `16722`
		// Minimum execution time: 303_678 nanoseconds.
		Weight::from_parts(306_419_000, 16722)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		Weight::from_parts(45_739_000, 6234)

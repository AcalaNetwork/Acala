...
impl<T: frame_system::Config> module_currencies::WeightInfo for WeightInfo<T> {
	...
	fn transfer_non_native_currency() -> Weight {
		// Minimum execution time: 46_564 nanoseconds.
		Weight::from_ref_time(48_326_000)
	...
	fn update_balance_native_currency_creating() -> Weight {
		// Minimum execution time: 27_915 nanoseconds.
	...
	fn update_balance_native_currency_killing() -> Weight {
		// Minimum execution time: 28_766 nanoseconds.
	...
	fn sweep_dust(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(17_762_569)
			// Standard Error: 28_031
			.saturating_add(Weight::from_ref_time(18_821_201).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn force_set_lock() -> Weight {
		...
		Weight::from_ref_time(28_166_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: Tokens Locks (r:1 w:1)
	...
	fn force_remove_lock() -> Weight {
		...
		Weight::from_ref_time(28_892_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
}

...
impl<T: frame_system::Config> nutsfinance_stable_asset::WeightInfo for WeightInfo<T> {
	...
	fn create_pool() -> Weight {
		...
		//  Measured:  `1345`
		//  Estimated: `4810`
		// Minimum execution time: 30_783 nanoseconds.
		Weight::from_parts(31_362_000, 4810)
	...
	fn modify_a() -> Weight {
		...
		Weight::from_parts(24_806_000, 5003)
	...
	fn modify_fees() -> Weight {
		...
		Weight::from_parts(23_835_000, 5003)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `StableAsset::Pools` (r:1 w:1)
	...
	fn modify_recipients() -> Weight {
		...
		Weight::from_parts(23_987_000, 5003)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `StableAsset::Pools` (r:1 w:1)
	...
	fn mint(u: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2262 + u * (186 ±0)`
		//  Estimated: `6196 + u * (5244 ±32)`
		// Minimum execution time: 172_922 nanoseconds.
		Weight::from_parts(84_682_684, 6196)
			// Standard Error: 428_229
			.saturating_add(Weight::from_parts(49_442_897, 0).saturating_mul(u.into()))
	...
	fn swap(u: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2489 + u * (183 ±0)`
		//  Estimated: `5972 + u * (2622 ±32)`
		// Minimum execution time: 2_280_839 nanoseconds.
		Weight::from_parts(445_030_959, 5972)
			// Standard Error: 3_834_727
			.saturating_add(Weight::from_parts(952_229_968, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn redeem_proportion(u: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2431 + u * (248 ±0)`
		//  Estimated: `5914 + u * (5244 ±0)`
		// Minimum execution time: 200_168 nanoseconds.
		Weight::from_parts(118_567_850, 5914)
			// Standard Error: 314_617
			.saturating_add(Weight::from_parts(46_060_981, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((4_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(3))
			.saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(u.into())))
	...
	fn redeem_single(u: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1625 + u * (227 ±0)`
		//  Estimated: `5141 + u * (1016 ±2)`
		// Minimum execution time: 1_798_350 nanoseconds.
		Weight::from_parts(807_843_547, 5141)
			// Standard Error: 2_476_524
			.saturating_add(Weight::from_parts(494_281_196, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn redeem_multi(u: u32, ) -> Weight {
		...
		//  Measured:  `2431 + u * (248 ±0)`
		//  Estimated: `5914 + u * (5244 ±0)`
		// Minimum execution time: 172_352 nanoseconds.
		Weight::from_parts(70_249_331, 5914)
			// Standard Error: 553_946
			.saturating_add(Weight::from_parts(57_162_296, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((4_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(3))
			.saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(u.into())))

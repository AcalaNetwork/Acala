...
impl<T: frame_system::Config> module_session_manager::WeightInfo for WeightInfo<T> {
	...
	fn schedule_session_duration() -> Weight {
		...
		Weight::from_parts(19_485_000, 3041)
	...
	fn on_initialize_skip() -> Weight {
		...
		Weight::from_parts(5_655_000, 3485)
	...
	fn on_initialize() -> Weight {
		...
		//  Measured:  `809`
		//  Estimated: `3485`
		// Minimum execution time: 5_862 nanoseconds.
		Weight::from_parts(6_113_000, 3485)
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn estimate_current_session_progress() -> Weight {
		...
		Weight::from_parts(4_190_000, 1489)
	...
	fn estimate_next_session_rotation() -> Weight {
		...
		Weight::from_parts(4_216_000, 1489)
			.saturating_add(T::DbWeight::get().reads(2))
	}
}

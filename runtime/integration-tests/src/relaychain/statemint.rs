...
pub const FEE_STATEMINT: Balance = 10_303_867;
...
fn acala_statemint_transfer_works() {
	...
	Statemint::execute_with(|| {
		...
		assert_eq!(1_000_036_593_308, Balances::free_balance(&AccountId::from(BOB)));
		assert_eq!(1_003_544_025_409, Balances::free_balance(&para_2000));
	});
}

...
impl<T: frame_system::Config> module_idle_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize() -> Weight {
		...
		//  Measured:  `681`
		//  Estimated: `2166`
		// Minimum execution time: 4_507 nanoseconds.
		Weight::from_parts(4_614_000, 2166)
	...
	fn on_idle_base() -> Weight {
		...
		//  Measured:  `790`
		//  Estimated: `2275`
		// Minimum execution time: 6_102 nanoseconds.
		Weight::from_parts(6_345_000, 2275)
	...
	fn clear_tasks() -> Weight {
		...
		Weight::from_parts(11_610_000, 833)
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn schedule_task() -> Weight {
		...
		//  Measured:  `1074`
		//  Estimated: `2559`
		// Minimum execution time: 20_359 nanoseconds.
		Weight::from_parts(20_874_000, 2559)
			.saturating_add(T::DbWeight::get().reads(1))

...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		Weight::from_parts(17_230_833, 3600)
			// Standard Error: 14_030
			.saturating_add(Weight::from_parts(806_093, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		//  Measured:  `345`
		//  Estimated: `3600`
		// Minimum execution time: 16_556 nanoseconds.
		Weight::from_parts(17_039_000, 3600)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		...
		//  Measured:  `715 + c * (29 ±0)`
		//  Estimated: `3612`
		// Minimum execution time: 58_663 nanoseconds.
		Weight::from_parts(61_201_579, 3612)
			// Standard Error: 17_597
			.saturating_add(Weight::from_parts(1_650_998, 0).saturating_mul(c.into()))

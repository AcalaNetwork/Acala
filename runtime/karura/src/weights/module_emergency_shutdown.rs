...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		Weight::from_parts(24_514_871, 3600)
			// Standard Error: 8_890
			.saturating_add(Weight::from_parts(479_084, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		Weight::from_parts(24_006_000, 3600)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2026 + c * (33 ±0)`
		//  Estimated: `3612`
		// Minimum execution time: 57_044 nanoseconds.
		Weight::from_parts(59_648_485, 3612)
			// Standard Error: 27_796
			.saturating_add(Weight::from_parts(1_862_035, 0).saturating_mul(c.into()))

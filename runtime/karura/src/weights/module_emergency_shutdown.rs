...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	fn emergency_shutdown(c: u32, ) -> Weight {
		(67_891_000 as Weight)
			// Standard Error: 68_000
			.saturating_add((3_410_000 as Weight).saturating_mul(c as Weight))
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		(130_152_000 as Weight)
			// Standard Error: 186_000
			.saturating_add((62_202_000 as Weight).saturating_mul(c as Weight))

...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	fn emergency_shutdown(c: u32, ) -> Weight {
		(99_423_000 as Weight)
			// Standard Error: 233_000
			.saturating_add((15_077_000 as Weight).saturating_mul(c as Weight))
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		(106_378_000 as Weight)
			// Standard Error: 151_000
			.saturating_add((63_137_000 as Weight).saturating_mul(c as Weight))

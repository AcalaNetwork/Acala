...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	fn emergency_shutdown(c: u32) -> Weight {
		(421_699_000 as Weight)
			// Standard Error: 301_000
			.saturating_add((24_649_000 as Weight).saturating_mul(c as Weight))
	...
	fn open_collateral_refund() -> Weight {
		(99_081_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(17 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn refund_collaterals(c: u32) -> Weight {
		(208_694_000 as Weight)
			// Standard Error: 243_000
			.saturating_add((58_006_000 as Weight).saturating_mul(c as Weight))

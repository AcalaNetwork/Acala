...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	// Storage: AcalaOracle IsUpdated (r:3 w:0)
	// Storage: OperatorMembershipAcala Members (r:1 w:0)
	// Storage: AcalaOracle RawValues (r:18 w:0)
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		(138_578_000 as Weight)
			// Standard Error: 1_297_000
			.saturating_add((18_367_000 as Weight).saturating_mul(c as Weight))
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		(90_280_000 as Weight)
			// Standard Error: 299_000
			.saturating_add((35_860_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(9 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(c as Weight)))

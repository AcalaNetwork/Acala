...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	fn emergency_shutdown(c: u32, ) -> Weight {
		(108_442_000 as Weight)
			// Standard Error: 136_000
			.saturating_add((30_622_000 as Weight).saturating_mul(c as Weight))
	...
	fn open_collateral_refund() -> Weight {
		(45_594_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	fn refund_collaterals(c: u32, ) -> Weight {
		(130_589_000 as Weight)
			// Standard Error: 119_000
			.saturating_add((74_410_000 as Weight).saturating_mul(c as Weight))

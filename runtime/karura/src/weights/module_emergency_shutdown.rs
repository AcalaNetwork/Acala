...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		//  Measured:  `1285`
		//  Estimated: `5086`
		// Minimum execution time: 23_633 nanoseconds.
		Weight::from_parts(24_727_445, 5086)
			// Standard Error: 13_709
			.saturating_add(Weight::from_parts(527_434, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		Weight::from_parts(24_002_000, 5086)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2025 + c * (33 ±0)`
		//  Estimated: `15755`
		// Minimum execution time: 58_215 nanoseconds.
		Weight::from_parts(60_963_071, 15755)
			// Standard Error: 35_933
			.saturating_add(Weight::from_parts(1_992_941, 0).saturating_mul(c.into()))

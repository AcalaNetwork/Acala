...
impl<T: frame_system::Config> module_dex::WeightInfo for WeightInfo<T> {
	...
	fn enable_trading_pair() -> Weight {
		// Minimum execution time: 17_543 nanoseconds.
		Weight::from_ref_time(17_941_000)
	...
	fn disable_trading_pair() -> Weight {
		...
		Weight::from_ref_time(18_934_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Dex TradingPairStatuses (r:1 w:1)
	...
	fn list_provisioning() -> Weight {
		...
		Weight::from_ref_time(24_869_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Dex TradingPairStatuses (r:1 w:1)
	fn update_provisioning_parameters() -> Weight {
		// Minimum execution time: 10_649 nanoseconds.
	...
	fn end_provisioning() -> Weight {
		// Minimum execution time: 47_387 nanoseconds.
		Weight::from_ref_time(49_004_000)
	...
	fn add_provision() -> Weight {
		...
		Weight::from_ref_time(76_755_000)
			.saturating_add(T::DbWeight::get().reads(5))
	...
	fn claim_dex_share() -> Weight {
		// Minimum execution time: 67_288 nanoseconds.
		Weight::from_ref_time(68_990_000)
	...
	fn add_liquidity() -> Weight {
		// Minimum execution time: 92_978 nanoseconds.
		Weight::from_ref_time(96_273_000)
	...
	fn add_liquidity_and_stake() -> Weight {
		// Minimum execution time: 128_294 nanoseconds.
		Weight::from_ref_time(133_587_000)
	...
	fn remove_liquidity() -> Weight {
		// Minimum execution time: 85_861 nanoseconds.
		Weight::from_ref_time(88_830_000)
	...
	fn remove_liquidity_by_unstake() -> Weight {
		// Minimum execution time: 139_244 nanoseconds.
		Weight::from_ref_time(141_462_000)
			.saturating_add(T::DbWeight::get().reads(11))
			.saturating_add(T::DbWeight::get().writes(9))
	}
	// Storage: Dex TradingPairStatuses (r:1 w:0)
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		// Minimum execution time: 71_043 nanoseconds.
		Weight::from_ref_time(51_371_939)
			// Standard Error: 69_494
			.saturating_add(Weight::from_ref_time(11_265_344).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		Weight::from_ref_time(51_306_400)
			// Standard Error: 65_566
			.saturating_add(Weight::from_ref_time(11_358_673).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn refund_provision() -> Weight {
		// Minimum execution time: 75_177 nanoseconds.
		Weight::from_ref_time(78_153_000)
			.saturating_add(T::DbWeight::get().reads(7))
	...
	fn abort_provisioning() -> Weight {
		...
		Weight::from_ref_time(23_020_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

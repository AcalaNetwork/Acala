...
impl<T: frame_system::Config> module_cdp_engine::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(c: u32, ) -> Weight {
		(8_907_000 as Weight)
			...
			.saturating_add((5_073_000 as Weight).saturating_mul(c as Weight))
	...
	fn liquidate_by_auction(b: u32, ) -> Weight {
		(171_382_000 as Weight)
			// Standard Error: 77_000
			.saturating_add((11_061_000 as Weight).saturating_mul(b as Weight))

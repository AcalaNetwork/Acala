...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(c: u32, ) -> Weight {
		...
		Weight::from_parts(18_111_773, 3086)
			// Standard Error: 44_376
			.saturating_add(Weight::from_parts(5_921_089, 0).saturating_mul(c.into()))
	...
	fn on_finalize() -> Weight {
		...
		//  Measured:  `840`
		//  Estimated: `0`
		// Minimum execution time: 6_198 nanoseconds.

...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(c: u32, ) -> Weight {
		// Minimum execution time: 17_263 nanoseconds.
		Weight::from_ref_time(19_218_639)
			// Standard Error: 37_944
			.saturating_add(Weight::from_ref_time(5_656_313).saturating_mul(c.into()))
	...
	fn on_finalize() -> Weight {
		// Minimum execution time: 5_777 nanoseconds.
		Weight::from_ref_time(6_172_000)
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

...
impl<T: frame_system::Config> orml_vesting::WeightInfo for WeightInfo<T> {
	...
	fn claim(i: u32) -> Weight {
		(66_281_000 as Weight)
			...
			.saturating_add((251_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn update_vesting_schedules(i: u32) -> Weight {
		(60_302_000 as Weight)
			// Standard Error: 2_000
			.saturating_add((204_000 as Weight).saturating_mul(i as Weight))

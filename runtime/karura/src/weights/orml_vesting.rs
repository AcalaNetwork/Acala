...
impl<T: frame_system::Config> orml_vesting::WeightInfo for WeightInfo<T> {
	...
	fn claim(i: u32, ) -> Weight {
		(62_693_000 as Weight)
			...
			.saturating_add((25_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
	}
	fn update_vesting_schedules(i: u32, ) -> Weight {
		(31_085_000 as Weight)
			// Standard Error: 2_000
			.saturating_add((99_000 as Weight).saturating_mul(i as Weight))

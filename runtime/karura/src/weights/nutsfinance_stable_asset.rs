...
impl<T: frame_system::Config> nutsfinance_stable_asset::WeightInfo for WeightInfo<T> {
	...
	fn mint(u: u32, ) -> Weight {
		(118_933_000 as Weight)
			// Standard Error: 1_070_000
			.saturating_add((19_913_000 as Weight).saturating_mul(u as Weight))
	...
	fn swap(u: u32, ) -> Weight {
		(108_572_000 as Weight)
			// Standard Error: 2_703_000
			.saturating_add((10_282_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(8 as Weight))
	...
	fn redeem_proportion(u: u32, ) -> Weight {
		(105_264_000 as Weight)
			...
			.saturating_add((22_019_000 as Weight).saturating_mul(u as Weight))
	...
	fn redeem_single(u: u32, ) -> Weight {
		(127_469_000 as Weight)
			// Standard Error: 610_000
			.saturating_add((4_704_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(8 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(u as Weight)))
			.saturating_add(T::DbWeight::get().writes(7 as Weight))
	}
	...
	fn redeem_multi(u: u32, ) -> Weight {
		(94_918_000 as Weight)
			...
			.saturating_add((24_380_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(u as Weight)))
			.saturating_add(T::DbWeight::get().writes(5 as Weight))
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(u as Weight)))

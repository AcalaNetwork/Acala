...
impl<T: frame_system::Config> nutsfinance_stable_asset::WeightInfo for WeightInfo<T> {
	...
	fn mint(u: u32, ) -> Weight {
		(125_697_000 as Weight)
			// Standard Error: 260_000
			.saturating_add((31_956_000 as Weight).saturating_mul(u as Weight))
	...
	fn swap(u: u32, ) -> Weight {
		(118_937_000 as Weight)
			// Standard Error: 159_000
			.saturating_add((9_337_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
	...
	fn redeem_proportion(u: u32, ) -> Weight {
		(123_216_000 as Weight)
			// Standard Error: 247_000
			.saturating_add((25_525_000 as Weight).saturating_mul(u as Weight))
	...
	fn redeem_single(u: u32, ) -> Weight {
		(145_485_000 as Weight)
			// Standard Error: 1_421_000
			.saturating_add((4_519_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(u as Weight)))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
	...
	fn redeem_multi(u: u32, ) -> Weight {
		(102_841_000 as Weight)
			// Standard Error: 175_000
			.saturating_add((25_476_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(u as Weight)))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(u as Weight)))

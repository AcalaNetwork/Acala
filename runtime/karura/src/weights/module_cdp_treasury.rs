...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		//  Measured:  `715`
		//  Estimated: `3612`
		// Minimum execution time: 49_058 nanoseconds.
		Weight::from_parts(44_647_762, 3612)
			// Standard Error: 23_682
			.saturating_add(Weight::from_parts(15_082_573, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `2400`
		//  Estimated: `16722`
		// Minimum execution time: 269_954 nanoseconds.
		Weight::from_parts(274_267_000, 16722)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		Weight::from_parts(45_068_000, 6234)

...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		//  Measured:  `2011`
		//  Estimated: `3612`
		// Minimum execution time: 40_974 nanoseconds.
		Weight::from_parts(39_610_293, 3612)
			// Standard Error: 15_999
			.saturating_add(Weight::from_parts(9_358_133, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `3947`
		//  Estimated: `16722`
		// Minimum execution time: 199_722 nanoseconds.
		Weight::from_parts(206_185_000, 16722)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		//  Measured:  `1436`
		//  Estimated: `6234`
		// Minimum execution time: 37_494 nanoseconds.
		Weight::from_parts(38_678_000, 6234)

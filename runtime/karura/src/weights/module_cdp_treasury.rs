...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		// Minimum execution time: 42_181 nanoseconds.
		Weight::from_ref_time(42_351_513)
			// Standard Error: 19_215
			.saturating_add(Weight::from_ref_time(11_268_082).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		// Minimum execution time: 191_885 nanoseconds.
		Weight::from_ref_time(198_430_000)
	...
	fn extract_surplus_to_treasury() -> Weight {
		// Minimum execution time: 41_727 nanoseconds.
		Weight::from_ref_time(42_909_000)

...
impl<T: frame_system::Config> module_incentives::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(c: u32, ) -> Weight {
		(6_061_000 as Weight)
			...
			.saturating_add((14_173_000 as Weight).saturating_mul(c as Weight))
	...
	fn update_incentive_rewards(c: u32, ) -> Weight {
		(5_410_000 as Weight)
			...
			.saturating_add((6_350_000 as Weight).saturating_mul(c as Weight))
	...
	fn update_dex_saving_rewards(c: u32, ) -> Weight {
		(3_536_000 as Weight)
			...
			.saturating_add((1_491_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(c as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(c as Weight)))
	...
	fn update_claim_reward_deduction_rates(c: u32, ) -> Weight {
		(3_118_000 as Weight)
			...
			.saturating_add((1_917_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(c as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(c as Weight)))

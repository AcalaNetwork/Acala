...
impl<T: frame_system::Config> module_incentives::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(c: u32, ) -> Weight {
		// Minimum execution time: 8_403 nanoseconds.
		Weight::from_ref_time(10_604_192)
			// Standard Error: 63_119
			.saturating_add(Weight::from_ref_time(15_196_050).saturating_mul(c.into()))
	...
	fn deposit_dex_share() -> Weight {
		// Minimum execution time: 60_279 nanoseconds.
		Weight::from_ref_time(62_497_000)
	...
	fn withdraw_dex_share() -> Weight {
		...
		Weight::from_ref_time(60_535_000)
	...
	fn claim_rewards() -> Weight {
		...
		Weight::from_ref_time(66_200_000)
			.saturating_add(T::DbWeight::get().reads(6))
			.saturating_add(T::DbWeight::get().writes(4))
	}
	...
	fn update_incentive_rewards(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(7_444_410)
			// Standard Error: 86_969
			.saturating_add(Weight::from_ref_time(7_411_273).saturating_mul(c.into()))
	...
	fn update_claim_reward_deduction_rates(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(5_169_874)
			// Standard Error: 14_412
			.saturating_add(Weight::from_ref_time(1_810_793).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(c.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(c.into())))
	}
}

...
impl<T: frame_system::Config> orml_authority::WeightInfo for WeightInfo<T> {
	fn dispatch_as() -> Weight {
		...
		//  Measured:  `965`
		//  Estimated: `0`
		// Minimum execution time: 16_532 nanoseconds.
	...
	fn schedule_dispatch_without_delay() -> Weight {
		...
		//  Measured:  `1111`
		//  Estimated: `11318`
		// Minimum execution time: 31_743 nanoseconds.
		Weight::from_parts(32_467_000, 11318)
	...
	fn schedule_dispatch_with_delay() -> Weight {
		...
		//  Measured:  `1111`
		//  Estimated: `11318`
		// Minimum execution time: 32_887 nanoseconds.
		Weight::from_parts(33_379_000, 11318)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn fast_track_scheduled_dispatch() -> Weight {
		...
		Weight::from_parts(42_133_000, 21646)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn delay_scheduled_dispatch() -> Weight {
		...
		Weight::from_parts(42_278_000, 21646)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn cancel_scheduled_dispatch() -> Weight {
		...
		//  Measured:  `1188`
		//  Estimated: `11318`
		// Minimum execution time: 31_937 nanoseconds.
		Weight::from_parts(32_990_000, 11318)
	...
	fn authorize_call() -> Weight {
		...
		//  Measured:  `965`
		//  Estimated: `965`
		// Minimum execution time: 16_583 nanoseconds.
		Weight::from_parts(16_885_000, 965)
	...
	fn remove_authorized_call() -> Weight {
		...
		//  Measured:  `1306`
		//  Estimated: `4771`
		// Minimum execution time: 22_092 nanoseconds.
		Weight::from_parts(22_707_000, 4771)
	...
	fn trigger_call() -> Weight {
		...
		Weight::from_parts(28_069_000, 4771)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

...
impl<T: frame_system::Config> module_currencies::WeightInfo for WeightInfo<T> {
	...
	fn update_balance_non_native_currency() -> Weight {
		(40_056_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	// Storage: System Account (r:1 w:1)
	fn update_balance_native_currency_creating() -> Weight {
		(43_989_000 as Weight)
	...
	fn sweep_dust(c: u32, ) -> Weight {
		(14_643_000 as Weight)
			...
			.saturating_add((27_935_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))

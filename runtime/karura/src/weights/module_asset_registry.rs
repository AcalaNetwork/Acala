...
impl<T: frame_system::Config> module_asset_registry::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset() -> Weight {
		...
		Weight::from_parts(25_664_000, 3607)
	...
	fn update_foreign_asset() -> Weight {
		...
		//  Measured:  `298`
		//  Estimated: `3763`
		// Minimum execution time: 24_453 nanoseconds.
		Weight::from_parts(25_286_000, 3763)
	...
	fn register_stable_asset() -> Weight {
		...
		Weight::from_parts(16_567_000, 3607)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn update_stable_asset() -> Weight {
		...
		//  Measured:  `236`
		//  Estimated: `3701`
		// Minimum execution time: 17_518 nanoseconds.
		Weight::from_parts(18_205_000, 3701)
	...
	fn register_erc20_asset() -> Weight {
		...
		//  Measured:  `4746`
		//  Estimated: `18111`
		// Minimum execution time: 236_385 nanoseconds.
		Weight::from_parts(237_897_000, 18111)
	...
	fn update_erc20_asset() -> Weight {
		...
		Weight::from_parts(25_048_000, 3852)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn register_native_asset() -> Weight {
		...
		//  Measured:  `142`
		//  Estimated: `3607`
		// Minimum execution time: 14_704 nanoseconds.
		Weight::from_parts(15_245_000, 3607)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `AssetRegistry::AssetMetadatas` (r:1 w:1)
	...
	fn update_native_asset() -> Weight {
		...
		Weight::from_parts(17_030_000, 3676)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

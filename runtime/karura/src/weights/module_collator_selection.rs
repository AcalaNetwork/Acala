...
impl<T: frame_system::Config> module_collator_selection::WeightInfo for WeightInfo<T> {
	...
	fn register_candidate(c: u32, ) -> Weight {
		(24_528_000 as Weight)
			...
			.saturating_add((415_000 as Weight).saturating_mul(c as Weight))
	...
	fn start_session(_r: u32, c: u32, ) -> Weight {
		(8_743_000 as Weight)
			...
			.saturating_add((1_144_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	...
	fn end_session(_r: u32, c: u32, ) -> Weight {
		(597_698_000 as Weight)
			// Standard Error: 44_000
			.saturating_add((5_379_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))

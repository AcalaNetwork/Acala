...
impl<T: frame_system::Config> module_collator_selection::WeightInfo for WeightInfo<T> {
	...
	fn start_session(r: u32, c: u32, ) -> Weight {
		(8_432_000 as Weight)
			...
			// Standard Error: 3_000
			.saturating_add((1_039_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	...
	fn end_session(_r: u32, c: u32, ) -> Weight {
		(498_991_000 as Weight)
			// Standard Error: 34_000
			.saturating_add((5_355_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))

...
impl<T: frame_system::Config> module_honzon::WeightInfo for WeightInfo<T> {
	...
	fn unauthorize_all(c: u32, ) -> Weight {
		(20_396_000 as Weight)
			// Standard Error: 390_000
			.saturating_add((4_040_000 as Weight).saturating_mul(c as Weight))

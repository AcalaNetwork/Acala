...
impl<T: frame_system::Config> module_honzon::WeightInfo for WeightInfo<T> {
	...
	fn authorize() -> Weight {
		Weight::from_ref_time(55_909_000)
	...
	fn unauthorize() -> Weight {
		Weight::from_ref_time(31_632_000)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: unknown [0x3a7472616e73616374696f6e5f6c6576656c3a] (r:1 w:1)
	...
	fn unauthorize_all(c: u32, ) -> Weight {
		Weight::from_ref_time(44_904_000)
			// Standard Error: 1_515_000
			.saturating_add(Weight::from_ref_time(3_131_000).saturating_mul(c as u64))
	...
	fn adjust_loan() -> Weight {
		Weight::from_ref_time(113_037_000)
	...
	fn transfer_loan_from() -> Weight {
		Weight::from_ref_time(94_466_000)
	...
	fn close_loan_has_debit_by_dex() -> Weight {
		Weight::from_ref_time(331_419_000)
	...
	fn expand_position_collateral() -> Weight {
		Weight::from_ref_time(213_680_000)
	...
	fn shrink_position_debit() -> Weight {
		Weight::from_ref_time(236_741_000)
			.saturating_add(T::DbWeight::get().reads(28 as u64))
	...
	fn transfer_debit() -> Weight {
		Weight::from_ref_time(134_833_000)
	...
	fn precompile_get_current_collateral_ratio() -> Weight {
		Weight::from_ref_time(32_475_000)

...
impl<T: frame_system::Config> module_honzon::WeightInfo for WeightInfo<T> {
	...
	fn unauthorize_all(c: u32, ) -> Weight {
		(32_001_000 as Weight)
			// Standard Error: 921_000
			.saturating_add((8_499_000 as Weight).saturating_mul(c as Weight))

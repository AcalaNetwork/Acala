...
impl<T: frame_system::Config> module_honzon::WeightInfo for WeightInfo<T> {
	...
	fn unauthorize_all(c: u32, ) -> Weight {
		(29_615_000 as Weight)
			// Standard Error: 839_000
			.saturating_add((7_896_000 as Weight).saturating_mul(c as Weight))

...
impl<T: frame_system::Config> module_dex_oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_update_average_prices(n: u32, u: u32, ) -> Weight {
		...
		//  Estimated: `17190 + n * (4487 ±33) + u * (1301 ±33)`
		// Minimum execution time: 18_657 nanoseconds.
		Weight::from_parts(19_291_000, 17190)
			// Standard Error: 155_470
			.saturating_add(Weight::from_parts(10_689_056, 0).saturating_mul(n.into()))
			// Standard Error: 155_470
			.saturating_add(Weight::from_parts(4_901_719, 0).saturating_mul(u.into()))
	...
	fn enable_average_price() -> Weight {
		...
		Weight::from_parts(22_410_000, 10393)
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn disable_average_price() -> Weight {
		...
		Weight::from_parts(14_478_000, 5251)
	...
	fn update_average_price_interval() -> Weight {
		...
		Weight::from_parts(13_953_000, 4358)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

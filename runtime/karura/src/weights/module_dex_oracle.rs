...
impl<T: frame_system::Config> module_dex_oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_update_average_prices(n: u32, u: u32, ) -> Weight {
		...
		// Minimum execution time: 13_778 nanoseconds.
		Weight::from_parts(14_313_000, 4851)
			// Standard Error: 142_362
			.saturating_add(Weight::from_parts(9_838_712, 0).saturating_mul(n.into()))
			// Standard Error: 142_362
			.saturating_add(Weight::from_parts(4_531_542, 0).saturating_mul(u.into()))
	...
	fn enable_average_price() -> Weight {
		...
		Weight::from_parts(19_664_000, 4421)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: `DexOracle::AveragePrices` (r:1 w:1)
	...
	fn disable_average_price() -> Weight {
		...
		//  Measured:  `927`
		//  Estimated: `4392`
		// Minimum execution time: 11_606 nanoseconds.
		Weight::from_parts(12_099_000, 4392)
	...
	fn update_average_price_interval() -> Weight {
		...
		Weight::from_parts(11_845_000, 4392)
			.saturating_add(T::DbWeight::get().reads(1))

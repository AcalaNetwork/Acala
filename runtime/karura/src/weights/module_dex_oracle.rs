...
impl<T: frame_system::Config> module_dex_oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize_with_update_average_prices(n: u32, u: u32, ) -> Weight {
		...
		//  Estimated: `4961 + n * (2864 ±2) + u * (346 ±2)`
		// Minimum execution time: 19_013 nanoseconds.
		Weight::from_parts(19_636_000, 4961)
			// Standard Error: 151_722
			.saturating_add(Weight::from_parts(10_483_057, 0).saturating_mul(n.into()))
			// Standard Error: 151_722
			.saturating_add(Weight::from_parts(4_774_128, 0).saturating_mul(u.into()))
	...
	fn enable_average_price() -> Weight {
		...
		Weight::from_parts(22_330_000, 4387)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: `DexOracle::AveragePrices` (r:1 w:1)
	...
	fn disable_average_price() -> Weight {
		...
		//  Measured:  `893`
		//  Estimated: `4358`
		// Minimum execution time: 14_004 nanoseconds.
		Weight::from_parts(14_349_000, 4358)
	...
	fn update_average_price_interval() -> Weight {
		...
		//  Measured:  `893`
		//  Estimated: `4358`
		// Minimum execution time: 13_533 nanoseconds.
		Weight::from_parts(13_826_000, 4358)
			.saturating_add(T::DbWeight::get().reads(1))

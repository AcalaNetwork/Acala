...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		...
		// Minimum execution time: 102_006 nanoseconds.
		Weight::from_parts(80_179_204, 6234)
			// Standard Error: 55_692
			.saturating_add(Weight::from_parts(12_348_058, 0).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		// Minimum execution time: 110_729 nanoseconds.
		Weight::from_parts(77_632_959, 6234)
			// Standard Error: 67_607
			.saturating_add(Weight::from_parts(18_129_599, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		...
		//  Measured:  `666`
		//  Estimated: `666`
		// Minimum execution time: 5_785 nanoseconds.
		Weight::from_parts(5_425_040, 666)
			// Standard Error: 11_403
			.saturating_add(Weight::from_parts(1_491_605, 0).saturating_mul(n.into()))

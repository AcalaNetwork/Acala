...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		...
		// Minimum execution time: 89_238 nanoseconds.
		Weight::from_parts(69_712_487, 6234)
			// Standard Error: 56_594
			.saturating_add(Weight::from_parts(11_126_897, 0).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		// Minimum execution time: 97_706 nanoseconds.
		Weight::from_parts(66_659_974, 6234)
			// Standard Error: 71_978
			.saturating_add(Weight::from_parts(17_112_054, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_681_113, 666)
			// Standard Error: 11_412
			.saturating_add(Weight::from_parts(1_467_865, 0).saturating_mul(n.into()))

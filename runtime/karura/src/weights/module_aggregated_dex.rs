...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		// Minimum execution time: 73_844 nanoseconds.
		Weight::from_ref_time(53_693_656)
			// Standard Error: 63_472
			.saturating_add(Weight::from_ref_time(11_450_537).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		// Minimum execution time: 81_680 nanoseconds.
		Weight::from_ref_time(50_903_147)
			// Standard Error: 72_146
			.saturating_add(Weight::from_ref_time(16_849_588).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		// Minimum execution time: 4_636 nanoseconds.
		Weight::from_ref_time(4_173_331)
			// Standard Error: 9_571
			.saturating_add(Weight::from_ref_time(1_491_856).saturating_mul(n.into()))

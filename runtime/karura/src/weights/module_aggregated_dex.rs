...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		...
		// Minimum execution time: 85_800 nanoseconds.
		Weight::from_parts(64_050_388, 17078)
			// Standard Error: 71_792
			.saturating_add(Weight::from_parts(12_410_412, 0).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		// Minimum execution time: 94_631 nanoseconds.
		Weight::from_parts(60_248_894, 17078)
			// Standard Error: 80_754
			.saturating_add(Weight::from_parts(18_659_185, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_208_057, 666)
			// Standard Error: 10_102
			.saturating_add(Weight::from_parts(1_672_737, 0).saturating_mul(n.into()))

...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(16_458_000 as Weight)
			...
			.saturating_add((50_399_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(5_523_000 as Weight)
			...
			.saturating_add((9_868_000 as Weight).saturating_mul(n as Weight))

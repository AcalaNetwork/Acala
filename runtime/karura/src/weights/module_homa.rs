...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(26_948_000 as Weight)
			// Standard Error: 134_000
			.saturating_add((52_682_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(9_450_000 as Weight)
			...
			.saturating_add((9_157_000 as Weight).saturating_mul(n as Weight))

...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(21_050_000 as Weight)
			// Standard Error: 213_000
			.saturating_add((52_390_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(8_733_000 as Weight)
			...
			.saturating_add((9_629_000 as Weight).saturating_mul(n as Weight))

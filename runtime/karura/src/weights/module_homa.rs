...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(17_071_000 as Weight)
			...
			.saturating_add((50_403_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(5_522_000 as Weight)
			...
			.saturating_add((7_781_000 as Weight).saturating_mul(n as Weight))

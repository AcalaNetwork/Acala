...
impl<T: frame_system::Config> module_homa::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_redeems(n: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((92_974_000 as Weight).saturating_mul(n as Weight))
	...
	fn reset_ledgers(n: u32, ) -> Weight {
		(9_878_000 as Weight)
			...
			.saturating_add((16_201_000 as Weight).saturating_mul(n as Weight))

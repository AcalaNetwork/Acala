...
impl<T: frame_system::Config> module_transaction_pause::WeightInfo for WeightInfo<T> {
	...
	fn pause_transaction() -> Weight {
		...
		//  Measured:  `4`
		//  Estimated: `3469`
		// Minimum execution time: 13_006 nanoseconds.
		Weight::from_parts(13_416_000, 3469)
	...
	fn unpause_transaction() -> Weight {
		...
		//  Measured:  `55`
		//  Estimated: `3520`
		// Minimum execution time: 14_645 nanoseconds.
		Weight::from_parts(15_002_000, 3520)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn pause_evm_precompile() -> Weight {
		...
		Weight::from_parts(13_236_000, 3469)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `TransactionPause::PausedEvmPrecompiles` (r:1 w:1)
	...
	fn unpause_evm_precompile() -> Weight {
		...
		//  Measured:  `65`
		//  Estimated: `3530`
		// Minimum execution time: 14_788 nanoseconds.
		Weight::from_parts(15_224_000, 3530)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

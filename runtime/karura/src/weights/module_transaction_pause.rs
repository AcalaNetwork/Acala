...
impl<T: frame_system::Config> module_transaction_pause::WeightInfo for WeightInfo<T> {
	...
	fn pause_transaction() -> Weight {
		...
		//  Measured:  `1139`
		//  Estimated: `4604`
		// Minimum execution time: 20_587 nanoseconds.
		Weight::from_parts(21_005_000, 4604)
	...
	fn unpause_transaction() -> Weight {
		...
		//  Measured:  `1190`
		//  Estimated: `4655`
		// Minimum execution time: 22_095 nanoseconds.
		Weight::from_parts(22_737_000, 4655)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn pause_evm_precompile() -> Weight {
		...
		//  Measured:  `1139`
		//  Estimated: `4604`
		// Minimum execution time: 20_152 nanoseconds.
		Weight::from_parts(20_742_000, 4604)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: TransactionPause PausedEvmPrecompiles (r:1 w:1)
	...
	fn unpause_evm_precompile() -> Weight {
		...
		Weight::from_parts(22_372_000, 4665)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}

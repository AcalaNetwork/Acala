...
impl<T: frame_system::Config> module_evm::WeightInfo for WeightInfo<T> {
	...
	fn create() -> Weight {
		Weight::from_ref_time(132_971_000)
	...
	// Storage: EVM ContractStorageSizes (r:1 w:1)
	fn create2() -> Weight {
		Weight::from_ref_time(129_757_000)
			.saturating_add(T::DbWeight::get().reads(13 as u64))
			.saturating_add(T::DbWeight::get().writes(10 as u64))
	}
	// Storage: unknown [0x3a7472616e73616374696f6e5f6c6576656c3a] (r:1 w:1)
	...
	fn create_nft_contract() -> Weight {
		Weight::from_ref_time(145_570_000)
	...
	fn create_predeploy_contract() -> Weight {
		Weight::from_ref_time(147_440_000)
			.saturating_add(T::DbWeight::get().reads(13 as u64))
	...
	// Storage: EVM ContractStorageSizes (r:1 w:1)
	fn call() -> Weight {
		Weight::from_ref_time(132_553_000)
	...
	fn transfer_maintainer() -> Weight {
		Weight::from_ref_time(90_360_000)
	...
	fn publish_contract() -> Weight {
		Weight::from_ref_time(106_847_000)
	...
	fn enable_contract_development() -> Weight {
		Weight::from_ref_time(94_134_000)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: unknown [0x3a7472616e73616374696f6e5f6c6576656c3a] (r:1 w:1)
	...
	fn set_code(c: u32, ) -> Weight {
		Weight::from_ref_time(148_428_000)
			// Standard Error: 0
	...
	fn selfdestruct() -> Weight {
		Weight::from_ref_time(114_929_000)

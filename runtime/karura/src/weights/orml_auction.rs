...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		...
		//  Measured:  `2437`
		//  Estimated: `8856`
		// Minimum execution time: 104_361 nanoseconds.
		Weight::from_parts(106_553_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		...
		// Minimum execution time: 103_676 nanoseconds.
		Weight::from_parts(38_765_912, 6330)
			// Standard Error: 36_545
			.saturating_add(Weight::from_parts(46_294_289, 0).saturating_mul(c.into()))

...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid() -> Weight {
		...
		//  Measured:  `1129`
		//  Estimated: `8856`
		// Minimum execution time: 117_108 nanoseconds.
		Weight::from_parts(121_213_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1048 + c * (179 ±0)`
		//  Estimated: `6330 + c * (2614 ±0)`
		// Minimum execution time: 123_995 nanoseconds.
		Weight::from_parts(60_498_680, 6330)
			// Standard Error: 28_861
			.saturating_add(Weight::from_parts(64_672_496, 0).saturating_mul(c.into()))

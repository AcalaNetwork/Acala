...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		// Minimum execution time: 89_019 nanoseconds.
		Weight::from_ref_time(92_717_000)
	...
	fn on_finalize(c: u32, ) -> Weight {
		// Minimum execution time: 93_154 nanoseconds.
		Weight::from_ref_time(43_121_022)
			// Standard Error: 21_790
			.saturating_add(Weight::from_ref_time(43_012_773).saturating_mul(c.into()))

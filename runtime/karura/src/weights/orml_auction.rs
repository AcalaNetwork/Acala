...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		...
		//  Measured:  `2470`
		//  Estimated: `8856`
		// Minimum execution time: 85_650 nanoseconds.
		Weight::from_parts(88_194_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		...
		// Minimum execution time: 91_749 nanoseconds.
		Weight::from_parts(49_388_579, 6330)
			// Standard Error: 22_150
			.saturating_add(Weight::from_parts(40_045_318, 0).saturating_mul(c.into()))

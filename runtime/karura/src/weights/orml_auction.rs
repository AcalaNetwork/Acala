...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		...
		//  Measured:  `2470`
		//  Estimated: `8856`
		// Minimum execution time: 89_209 nanoseconds.
		Weight::from_parts(90_829_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		...
		// Minimum execution time: 93_116 nanoseconds.
		Weight::from_parts(54_965_635, 6330)
			// Standard Error: 16_461
			.saturating_add(Weight::from_parts(40_572_235, 0).saturating_mul(c.into()))

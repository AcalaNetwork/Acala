...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	fn emergency_shutdown(c: u32, ) -> Weight {
		(182_765_000 as Weight)
			// Standard Error: 186_000
			.saturating_add((23_408_000 as Weight).saturating_mul(c as Weight))
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		(140_935_000 as Weight)
			// Standard Error: 510_000
			.saturating_add((60_895_000 as Weight).saturating_mul(c as Weight))

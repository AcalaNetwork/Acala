...
impl<T: frame_system::Config> module_emergency_shutdown::WeightInfo for WeightInfo<T> {
	...
	fn emergency_shutdown(c: u32, ) -> Weight {
		...
		//  Measured:  `321`
		//  Estimated: `3600`
		// Minimum execution time: 15_676 nanoseconds.
		Weight::from_parts(16_992_540, 3600)
			// Standard Error: 13_551
			.saturating_add(Weight::from_parts(703_479, 0).saturating_mul(c.into()))
	...
	fn open_collateral_refund() -> Weight {
		...
		Weight::from_parts(17_372_000, 3600)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn refund_collaterals(c: u32, ) -> Weight {
		...
		//  Measured:  `715 + c * (29 ±0)`
		//  Estimated: `3612`
		// Minimum execution time: 59_214 nanoseconds.
		Weight::from_parts(61_420_942, 3612)
			// Standard Error: 20_666
			.saturating_add(Weight::from_parts(1_434_498, 0).saturating_mul(c.into()))

...
//! Autogenerated weights for ecosystem_chainsafe
//!
...
/// Weight functions for ecosystem_chainsafe.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> ecosystem_chainsafe::WeightInfo for WeightInfo<T> {

...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid_collateral_auction() -> Weight {
		...
		//  Measured:  `3482`
		//  Estimated: `23113`
		// Minimum execution time: 113_605 nanoseconds.
		Weight::from_parts(117_095_000, 23113)
	...
	fn on_finalize(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `3573 + c * (979 ±0)`
		//  Estimated: `51976 + c * (9624 ±0)`
		// Minimum execution time: 119_698 nanoseconds.
		Weight::from_parts(75_697_856, 51976)
			// Standard Error: 23_733
			.saturating_add(Weight::from_parts(51_039_900, 0).saturating_mul(c.into()))

...
impl<T: frame_system::Config> orml_auction::WeightInfo for WeightInfo<T> {
	...
	fn bid() -> Weight {
		...
		//  Measured:  `1127`
		//  Estimated: `8856`
		// Minimum execution time: 120_094 nanoseconds.
		Weight::from_parts(122_904_000, 8856)
	...
	fn on_finalize(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1048 + c * (177 ±0)`
		//  Estimated: `6330 + c * (2614 ±0)`
		// Minimum execution time: 126_333 nanoseconds.
		Weight::from_parts(54_979_577, 6330)
			// Standard Error: 29_148
			.saturating_add(Weight::from_parts(66_841_985, 0).saturating_mul(c.into()))

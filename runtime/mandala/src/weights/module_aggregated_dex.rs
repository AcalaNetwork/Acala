...
impl<T: frame_system::Config> module_aggregated_dex::WeightInfo for WeightInfo<T> {
	...
	fn swap_with_exact_supply(u: u32, ) -> Weight {
		...
		// Minimum execution time: 93_581 nanoseconds.
		Weight::from_parts(72_459_455, 17078)
			// Standard Error: 77_915
			.saturating_add(Weight::from_parts(12_315_823, 0).saturating_mul(u.into()))
	...
	fn swap_with_exact_target(u: u32, ) -> Weight {
		...
		//  Measured:  `2602 + u * (108 ±0)`
		//  Estimated: `17078 + u * (1270 ±19)`
		// Minimum execution time: 102_410 nanoseconds.
		Weight::from_parts(69_607_812, 17078)
			// Standard Error: 86_638
			.saturating_add(Weight::from_parts(18_464_761, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(u.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(u.into())))
	...
	fn update_aggregated_swap_paths(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_357_943, 666)
			// Standard Error: 10_407
			.saturating_add(Weight::from_parts(1_631_908, 0).saturating_mul(n.into()))

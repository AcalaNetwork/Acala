...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		Weight::from_parts(42_131_463, 3612)
			// Standard Error: 13_311
			.saturating_add(Weight::from_parts(9_224_010, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `5624`
		//  Estimated: `21966`
		// Minimum execution time: 329_496 nanoseconds.
		Weight::from_parts(338_514_000, 21966)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		Weight::from_parts(43_015_000, 6234)

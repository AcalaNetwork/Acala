...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		Weight::from_parts(46_189_845, 3612)
			// Standard Error: 24_027
			.saturating_add(Weight::from_parts(15_143_179, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `2434`
		//  Estimated: `16722`
		// Minimum execution time: 273_743 nanoseconds.
		Weight::from_parts(277_500_000, 16722)
	...
	fn set_expected_collateral_auction_size() -> Weight {
		...
		Weight::from_parts(10_569_000, 0)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		Weight::from_parts(45_249_000, 6234)

...
impl<T: frame_system::Config> module_cdp_treasury::WeightInfo for WeightInfo<T> {
	...
	fn auction_collateral(b: u32, ) -> Weight {
		...
		//  Measured:  `2814`
		//  Estimated: `17259`
		// Minimum execution time: 54_551 nanoseconds.
		Weight::from_parts(55_725_931, 17259)
			// Standard Error: 23_040
			.saturating_add(Weight::from_parts(13_556_095, 0).saturating_mul(b.into()))
	...
	fn exchange_collateral_to_stable() -> Weight {
		...
		//  Measured:  `5642`
		//  Estimated: `112866`
		// Minimum execution time: 380_584 nanoseconds.
		Weight::from_parts(383_023_000, 112866)
	...
	fn extract_surplus_to_treasury() -> Weight {
		...
		Weight::from_parts(56_646_000, 12430)

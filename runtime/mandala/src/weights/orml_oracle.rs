...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	fn feed_values(c: u32, ) -> Weight {
		...
		//  Measured:  `1283 + c * (25 ±0)`
		//  Estimated: `3086 + c * (2590 ±0)`
		// Minimum execution time: 16_234 nanoseconds.
		Weight::from_parts(18_643_550, 3086)
			// Standard Error: 61_602
			.saturating_add(Weight::from_parts(9_377_300, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(c.into())))
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(c.into())))
			.saturating_add(Weight::from_parts(0, 2590).saturating_mul(c.into()))
	}

...
impl<T: frame_system::Config> orml_oracle::WeightInfo for WeightInfo<T> {
	...
	// Storage: `AcalaOracle::Values` (r:3 w:3)
	...
	fn feed_values(x: u32, ) -> Weight {
		...
		Weight::from_parts(19_820_867, 3086)
			// Standard Error: 30_632
			.saturating_add(Weight::from_parts(14_873_390, 0).saturating_mul(x.into()))

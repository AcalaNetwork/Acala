...
impl<T: frame_system::Config> module_transaction_payment::WeightInfo for WeightInfo<T> {
	...
	fn set_alternative_fee_swap_path() -> Weight {
		...
		Weight::from_parts(35_642_000, 3633)
	...
	fn enable_charge_fee_pool() -> Weight {
		...
		//  Measured:  `3044`
		//  Estimated: `41569`
		// Minimum execution time: 113_226 nanoseconds.
		Weight::from_parts(117_359_000, 41569)
	...
	fn disable_charge_fee_pool() -> Weight {
		...
		Weight::from_parts(90_356_000, 16884)
	...
	fn with_fee_path() -> Weight {
		...
		Weight::from_parts(14_120_000, 4306)
			.saturating_add(T::DbWeight::get().reads(1))
	}
	// Storage: TransactionPause PausedTransactions (r:1 w:0)
	// Proof Skipped: TransactionPause PausedTransactions (max_values: None, max_size: None, mode: Measured)
	fn with_fee_currency() -> Weight {
		...
		Weight::from_parts(15_019_000, 4306)
			.saturating_add(T::DbWeight::get().reads(1))
	}
	// Storage: TransactionPause PausedTransactions (r:1 w:0)
	// Proof Skipped: TransactionPause PausedTransactions (max_values: None, max_size: None, mode: Measured)
	...
	fn on_finalize() -> Weight {
		...
		Weight::from_parts(10_605_000, 1501)
			.saturating_add(T::DbWeight::get().reads(1))

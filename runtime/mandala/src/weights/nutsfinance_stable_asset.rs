...
impl<T: frame_system::Config> nutsfinance_stable_asset::weights::WeightInfo for WeightInfo<T> {
	...
	fn mint(u: u32) -> Weight {
		(86_058_000 as Weight) // Standard Error: 384_000
			.saturating_add((33_480_000 as Weight).saturating_mul(u as Weight))
	...
	fn redeem_proportion(u: u32) -> Weight {
		(90_887_000 as Weight) // Standard Error: 51_000
			.saturating_add((21_808_000 as Weight).saturating_mul(u as Weight))
	...
	fn redeem_multi(u: u32) -> Weight {
		(76_186_000 as Weight) // Standard Error: 87_000
			.saturating_add((21_640_000 as Weight).saturating_mul(u as Weight))
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(u as Weight)))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(u as Weight)))

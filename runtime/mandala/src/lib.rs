...
use cumulus_pallet_parachain_system::{RelayNumberStrictlyIncreases, RelaychainBlockNumberProvider};
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		PhragmenElection: pallet_elections_phragmen::{Pallet, Call, Storage, Event<T>, Config<T>} = 71,
		...
		AggregatedDex: module_aggregated_dex::{Pallet, Storage, Call} = 113,
		...
		AssetRegistry: module_asset_registry::{Pallet, Call, Config<T>, Storage, Event<T>} = 142,
		...
		Payments: orml_payments::{Pallet, Call, Storage, Event<T>} = 201,

...
use module_support::{
	...
	EmergencyShutdown, ExchangeRate, ExchangeRateProvider, PriceProvider, Rate,
};
...
pub use primitives::{
	...
	task::TaskResult,
	Address, Amount, AuctionId, BlockNumber, CurrencyId, DexShare, Header, Lease, Moment, Nonce, ReserveIdentifier,

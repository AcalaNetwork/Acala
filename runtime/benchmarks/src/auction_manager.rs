...
#[macro_export]
macro_rules! auction_manager_benchmarks {
	() => {
		use crate::{
			benchmarking::utils::feed_price, dollar, AcalaOracle, AccountId, AuctionId, AuctionManager, CdpTreasury,
			Currencies, CurrencyId, EmergencyShutdown, GetStableCurrencyId, GetStakingCurrencyId, MinimumCount,
			OperatorMembershipAcala, Price, Runtime,
		};

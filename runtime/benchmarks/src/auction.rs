...
#[macro_export]
macro_rules! auction_benchmarks {
	() => {
		use crate::{
			benchmarking::utils::set_balance, dollar, AccountId, Auction, AuctionId, AuctionManager,
			AuctionTimeToClose, CdpTreasury, Currencies, CurrencyId, GetStableCurrencyId, GetStakingCurrencyId,
			Runtime, System,
		};

...
#[macro_export]
macro_rules! emergency_shutdown_benchmarks {
	() => {
		use crate::{
			benchmarking::utils::{feed_price, set_balance},
			dollar, AcalaOracle, AccountId, CdpTreasury, CollateralCurrencyIds, CurrencyId, EmergencyShutdown,
			GetStableCurrencyId, Price, Runtime,
		};
